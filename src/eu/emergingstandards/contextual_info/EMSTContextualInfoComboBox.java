 ...
 */
public class EMSTContextualInfoComboBox extends AbstractInplaceEditor implements InplaceRenderer {

    private static final Logger logger = Logger.getLogger(EMSTContextualInfoComboBox.class.getName());
    ...
    private JComboBox<ArrayList<EMSTContextualItem>> comboBox;
    private final JButton editButton;

//    private final java.awt.Font defaultFont;

    public EMSTContextualInfoComboBox() {
        panel = new JPanel(new BorderLayout(HGAP, VGAP));

        EMSTIcon icon = EMSTIcon.get("document_edit");
    ...
    private void prepareComboBox(AuthorInplaceContext context) {
        String value = EMSTUtils.nullToEmpty((String) context.getArguments().get(InplaceEditorArgumentKeys.INITIAL_VALUE));
