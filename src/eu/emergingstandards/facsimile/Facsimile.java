...
import static eu.emergingstandards.utils.MainUtils.castFileToURL;
import static eu.emergingstandards.utils.MainUtils.castURLToFile;
import static eu.emergingstandards.utils.OxygenUtils.*;
import static eu.emergingstandards.utils.XMLUtils.XML_BASE_ATTRIB_NAME;
...
public class Facsimile extends AbstractMediaElement {
    ...
    @Nullable
    public static Facsimile createFacsimileElement(AuthorAccess authorAccess) throws EMSTException {
