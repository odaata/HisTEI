...
//    private static Logger logger = Logger.getLogger(HTExtensionsBundle.class.getName());

    private HTAuthorExtensionStateListener authorExtensionStateListener;
    private HTSchemaManagerFilter schemaManagerFilter;
    ...
    *   Alas, it only resolves things passed into the url() css function which is what I use to render the link image :-( */
    ...
    public AuthorReferenceResolver createAuthorReferenceResolver() {
        return new HTReferenceResolver();
    }*/
