 ...
 * <p/>
 * Generic exception thrown by an HT object
 */
public class HTException extends Exception {
     ...
     * @since 1.7
     */
    public HTException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
    ...
    protected String generateMessage() {
        ...
        if (message == null || message.isEmpty()) {
            message = "A HisTEI error has occurred!";
        }
